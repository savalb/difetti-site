...
const LINEE = [
  {
    ...
    formati: ['Candele', 'Paccheri', 'Spaghetti', 'Fusilli'],
    badge: 'KM VERO',
    href: '/difetti/pasta',
    bgDark: false,
  },
  {
    ...
    corpo: `Pomodoro arancione, giallo, verde. Varietà che non trovi al supermercato perché non sono "fotogeniche". Sono però esplosive di sapore.\n\nNiente addensanti, niente coloranti, niente conservanti. Solo frutto, succo di limone biologico e il calore del sole campano. Il colore opaco e disomogeneo è la firma dell'autenticità.`,
    img: '/images/prodotti/passata-pomodoro.jpg',
    formati: ['Passata arancione', 'Passata gialla', 'Pomodorini interi', 'Polpa rustica'],
    badge: 'ARTIGIANALE',
  ...
  },
  {
    ...
    formati: ['Crostata albicocca', 'Crostata mirtilli', 'Crostata frutti di bosco', 'Crostata limone'],
    badge: 'FATTO A MANO',
